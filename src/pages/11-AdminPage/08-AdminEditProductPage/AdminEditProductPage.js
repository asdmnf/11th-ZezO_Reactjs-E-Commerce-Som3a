            ...
            <div className="admin-content">
              <div className="admin-add-product">
                <div className="col-lg-10 col-xl-8">
                  ...
                  <input type="text" placeholder="اسم المنتج" onChange={productNameOnChangeHandle} value={productName} />
                  <textarea placeholder="وصف المنتج" onChange={productDescriptionOnChangeHandle} value={productDescription}></textarea>
                  <input type="number" placeholder="سعر المنتج " onChange={productPriceOnChangeHandle} value={productPrice} />
                  ...
                  <input type="number" placeholder="الكمية المتاحة " onChange={productAvailableQuantityOnChangeHandle} value={productAvailableQuantity} />
